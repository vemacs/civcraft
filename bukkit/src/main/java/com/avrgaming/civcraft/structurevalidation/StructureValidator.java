...
public class StructureValidator implements Runnable {
    ...
    public static boolean isEnabled() {
        try {
            return Boolean.valueOf(CivSettings.getString(CivSettings.civConfig, "global.structure_validation"));
        ...
        for (int y = cornerLoc.getY() - 1; y > 0; y--) {
            ...
            if (valid) {
                if (percentValid < Buildable.getReinforcementRequirementForLevel(checkedLevelCount)) {
                    ...
                    message = "Layer: " + y + " is " + df.format(percentValid * 100) + "%(" + reinforcementValue + "/" +
                              totalBlocks +
