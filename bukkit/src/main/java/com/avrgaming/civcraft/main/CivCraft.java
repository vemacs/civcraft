...
public final class CivCraft extends JavaPlugin {
    ...
    private void startTimers() {
        ...
        try {
            ...
            //			double cannon_firerate = CivSettings.getDouble(CivSettings.warConfig, 
            // "cannon_tower.fire_rate");
        ...
        //	TaskMaster.asyncTimer("StructureValidationPunisher", new StructureValidationPunisher(), 
        // TimeTools.toTicks(30));

        // Production version
        TaskMaster.asyncTask(new StructureValidationChecker(), TimeTools.toTicks(120));
        TaskMaster
                .asyncTimer("StructureValidationPunisher", new StructureValidationPunisher(), TimeTools.toTicks(3600));
