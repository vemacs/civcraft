...
public class CivData {
	...
	public static final String BOOK_UNDERLINE = ChatColor.UNDERLINE + "";
	public static final String BOOK_BOLD = ChatColor.BOLD + "";
	public static final String BOOK_ITALIC = ChatColor.ITALIC + "";
	public static final String BOOK_NORMAL = ChatColor.RESET + "";
