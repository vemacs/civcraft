...
public abstract class CommonCustomMob implements ICustomMob {
	...
	public PathfinderGoalSelector getGoalSelector() {
		...
		Field gsa;
		try {
			gsa = net.minecraft.server.v1_7_R3.EntityInsentient.class.getDeclaredField("goalSelector");
	...
	public PathfinderGoalSelector getTargetSelector() {
		Field gsa;
		try {
			gsa = net.minecraft.server.v1_7_R3.EntityInsentient.class.getDeclaredField("targetSelector");
			gsa.setAccessible(true);
			return (PathfinderGoalSelector)gsa.get((EntityInsentient)entity);
		} catch (NoSuchFieldException e) {
			e.printStackTrace();
	...
	public void printGoals(PathfinderGoalSelector goals) {
	    ...
	    Field gsa;
		try {
			gsa = net.minecraft.server.v1_7_R3.PathfinderGoalSelector.class.getDeclaredField("b");
			gsa.setAccessible(true);
