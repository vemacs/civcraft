    ...
    public static void processAction(String action, ItemStack stack, InventoryClickEvent event) {
        ...
        switch (args[0].toLowerCase()) {
            ...
            case "buildwithdefaultpersonaltemplate":
                ...
                try {
                    path = Template.getTemplateFilePath(info.template_base_name,
                                                        Template.getDirection(player.getLocation()),
                                                        TemplateType.STRUCTURE, "default");
                    try {
                    ...
                    centerLoc = Buildable.repositionCenterStatic(player.getLocation(), info,
                                                                 Template.getDirection(player.getLocation()),
                    ...
                    TaskMaster.asyncTask(
                            new StructureValidator(player, tpl.getFilepath(), centerLoc, resident.pendingCallback), 0);
                    player.closeInventory();
					...
					/* Use a template defined by a perk. */
						...
						/* get the template name from the perk's CustomTemplate component. */
                            ...
                            if (customTemplate != null) {
                                ...
                                CustomPersonalTemplate customPersonalTemplate =
                                        (CustomPersonalTemplate) perk.getComponent("CustomPersonalTemplate");
                            ...
                            CivLog.error(
                                    "Couldn't activate perk:" + args[1] + " cause it wasn't found in perks hashmap.");
                        }
                    } else {
